...
```sql
insert into flight_schedule values('YB525', current_date, 'SIN', 'IND', (now()+interval '300 minutes')::timestamp, (now()+interval '300 minutes')::timestamp, (now()+interval '300 minutes')::timestamp, (now()+interval '20 minutes')::timestamp, (now()+interval '20 minutes')::timestamp, (now()+interval '20 minutes')::timestamp, 'T4', 'T4');
```
